...
import { validateAcademicYearForm } from '../../data/academicYears.js'
...
const modalTitle = computed(() =>
  isEditMode.value ? t('pages.semester.editAcademicYear') : t('pages.semester.createAcademicYear'),
)
...
function handleSave() {
  ...
  const validationErrors = validateAcademicYearForm(
    payload,
    props.allItems,
    ...
    <div v-if="visible" class="modal-overlay" @click="handleOverlayClick">
      <div class="modal-panel" role="dialog" aria-modal="true">
        ...
        <div class="modal-form">
          <div class="form-row">
            <label class="form-label"><span class="required">*</span> {{ tr('Academic Year Code:') }}</label>
            <input
              v-model="form.code"
              type="text"
              class="form-input"
