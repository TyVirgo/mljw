...
export const registrationLogs = ref([
  ...
  log({
    ...
    courseKey: 'COMP201',
    sectionCode: '02',
    operatedAt: '2026-09-01 08:22:10',
    remark: '选课成功',
    operation: 'register',
    result: 'success',
  }),
  log({
    ...
    courseKey: 'IT102',
    sectionCode: '01',
    operatedAt: '2026-09-01 08:35:41',
    remark: '选课成功',
    operation: 'register',
    result: 'success',
  }),
  log({
    ...
    courseKey: 'PHYS101',
    sectionCode: '01',
    operatedAt: '2026-09-01 09:02:18',
    remark: '选课失败：课程已满',
    operation: 'register',
    result: 'failure',
  }),
  log({
    ...
    courseKey: 'ENGL201',
    sectionCode: '02',
    operatedAt: '2026-09-01 09:18:55',
    remark: '进入排队，当前顺位 2',
    operation: 'joinQueue',
    result: 'queuing',
    queueRank: 2,
  ...
  log({
    ...
    studentKey: 'COS2504015',
    courseKey: 'COMP220',
    operatedAt: '2026-09-01 09:40:03',
    remark: '选课成功',
    operation: 'register',
    result: 'success',
  }),
  log({
    ...
    courseKey: 'MATH201',
    sectionCode: '02',
    operatedAt: '2026-09-01 10:05:27',
    remark: '选课失败：先到先选超出一门限制',
    operation: 'register',
    result: 'failure',
  }),
  log({
    ...
    studentKey: 'AIT2409010',
    courseKey: 'HUM110',
    operatedAt: '2026-09-01 10:21:14',
    remark: '选课成功',
    operation: 'register',
    result: 'success',
  }),
  log({
    ...
    courseKey: 'STAT201',
    sectionCode: '01',
    operatedAt: '2026-09-01 10:44:50',
    remark: '取消排队',
    operation: 'cancelQueue',
    result: 'cancelQueue',
  }),
  log({
    ...
    studentKey: 'ACC2409008',
    courseKey: 'COS210',
    operatedAt: '2026-09-01 11:08:33',
    remark: '选课成功',
    operation: 'register',
    result: 'success',
  }),
  log({
    ...
    studentKey: 'MAT2504003',
    courseKey: 'MPU3183',
    operatedAt: '2026-09-01 11:30:02',
    remark: '进入排队，当前顺位 4',
    operation: 'joinQueue',
    result: 'queuing',
    queueRank: 4,
  ...
  log({
    ...
    operatedAt: '2026-09-01 13:12:40',
    remark: '管理端代选成功',
    operation: 'adminAdd',
    result: 'success',
  }),
  log({
    ...
    studentKey: 'SWE2409012',
    courseKey: 'MATH201',
    operatedAt: '2026-09-01 13:28:19',
    remark: '选课失败：原因：选课时间已截止',
    operation: 'register',
    result: 'failure',
  }),
  log({
    ...
    courseKey: 'PHYS101',
    sectionCode: '02',
    operatedAt: '2026-09-01 14:05:08',
    remark: '选课成功',
    operation: 'register',
    result: 'success',
  }),
  log({
    ...
    studentKey: 'DSA2504002',
    courseKey: 'ENGL201',
    operatedAt: '2026-09-01 14:22:51',
    remark: '取消排队',
    operation: 'cancelQueue',
    result: 'cancelQueue',
  }),
  log({
    ...
    courseKey: 'COMP201',
    sectionCode: '01',
    operatedAt: '2026-09-01 15:01:16',
    remark: '选课成功',
    operation: 'register',
    result: 'success',
  }),
